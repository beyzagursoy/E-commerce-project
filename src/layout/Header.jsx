    ...
    <header className="w-full font-montserrat sticky top-0 z-50 bg-white shadow-sm">
      ...
      <nav className="w-full bg-white px-8 py-4 lg:py-6">
        <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center">
          ...
          `}>
            {/* Navigation Links - */}
            <Link to="/" className={`hover:text-[#23A6F0] ${isActive('/') ? 'text-[#252B42]' : ''}`}>Home</Link>
            <Link to="/shop" className={`flex items-center gap-1 hover:text-[#23A6F0] ${isActive('/shop') ? 'text-[#252B42]' : ''}`}>
            ...
            {/* MOBILE ONLY ACTIONS - */}
            <div className="flex lg:hidden flex-col items-center gap-8 text-[#23A6F0] mt-4">
