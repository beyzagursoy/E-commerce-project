                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <div className="flex-1 lg:sticky lg:top-24 w-full lg:max-w-[350px]">
                        ...
                        <button
                            ...
                            className="w-full bg-[#23A6F0] text-white py-4 rounded-xl font-bold text-base hover:bg-[#1a8cd3] transition-all shadow-md mb-4 flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            onClick={handleConfirmCart}
                            className="w-full bg-[#23A6F0] text-white py-4 rounded-xl font-bold text-base hover:bg-[#1a8cd3] transition-all shadow-md mt-4 flex items-center justify-center gap-2"
                        >
                            Sepeti Onayla <ChevronRight size={18} />
                        </button>
                    </div>
